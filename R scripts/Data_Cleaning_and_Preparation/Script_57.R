...
setwd("C:/Users/rafre/Dropbox/Fiverr/Trabalhos/2024/trackrecord/Fourth Wave")


#gs4_auth()  # This will open a browser window for you to authenticate

# Specify the Google Sheet URL
sheet_url <- "https://docs.google.com/spreadsheets/d/17Pczg__U1lrKm2dZAWgi_aSJynVJboVXcU9sLZKhb8U/edit?gid=211251707#gid=211251707"
...
# Define leader groups for Legal and Finance
legal_leaders <- c(
  "Jake McGrady",
  "Ana Baloiu"
)
...
finance_leaders <- c(
  ...
  "Kirk Martin",
  "Felicia Wolford",
  "Dwain Kreipl",  # Ensuring correct spelling from the initial list
  "Ryan Marquez",
  "Joon Park"
)

# Create the mean and 95% CI plots for each group
create_mean_ci_plots(df_recoded_nooutliers, scales_scores, leader_col, "Legal", legal_leaders)
create_mean_ci_plots(df_recoded_nooutliers, scales_scores, leader_col, "Finance", finance_leaders)
...
create_heatmap(df_recoded_nooutliers, "Legal", legal_leaders)
create_heatmap(df_recoded_nooutliers, "Finance", finance_leaders)
