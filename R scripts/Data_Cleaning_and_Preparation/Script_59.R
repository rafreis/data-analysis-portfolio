...
sheet_url <- "https://docs.google.com/spreadsheets/d/1Qkqi-SGIsVCY-vTu-0Z5KC143jzKZ8pdpUihw0CJAYU/edit?gid=726562237#gid=726562237"

# Get all sheet names
sheet_names <- sheet_names(sheet_url)

# Select only the first 18 sheet names
sheet_names <- sheet_names[1:19]
...
setwd("C:/Users/rafre/Dropbox/Fiverr/Trabalhos/2024/trackrecord/Second Wave")
