...
long_data <- df %>% 
  pivot_longer(
    cols = c(Split_5m_Pre, Split_5m_Post, Vmax_Pre, Vmax_Post, PercPAH_Pre, PercPAH_Post, F0_Pre, F0_Post,
             V0_Pre, V0_Post, Pmax_Pre, Pmax_Post, rPmax_Pre, rPmax_Post, Sfv_Pre, Sfv_Post, rSfv_Pre, rSfv_Post, Drf_Pre, Drf_Post, RFMax_Pre, RFMax_Post, Vhmax_Pre, Vhmax_Post),
...
# Selecting relevant columns for the transformation
selected_columns <- c("Code", "Group", 
                      "Split_5m_Pre", "Split_5m_Post", "Vmax_Pre", "Vmax_Post", "F0_Pre", "F0_Post",
                      "V0_Pre", "V0_Post", "Pmax_Pre", "Pmax_Post", "rPmax_Pre", "rPmax_Post", 
                      "Sfv_Pre", "Sfv_Post", "rSfv_Pre", "rSfv_Post", "Drf_Pre", "Drf_Post", "RFMax_Pre", 
                      "RFMax_Post", "Vhmax_Pre", "Vhmax_Post", 
...
dependent_vars = c("Split_5m", "Split_10m", "Split_20m", "Vmax", "F0", "V0", "Pmax", "rPmax", "Sfv", "rSfv", "Drf", "RFMax", "Vhmax")
