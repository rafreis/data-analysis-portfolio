...
setwd("C:/Users/rafre/Dropbox/Fiverr/Trabalhos/2024/dalia/")
...
df <- read.xlsx("Verified data 2 - qual 7.xlsx")
...
kappa_data_treated <- df_filtered %>%
...
kappa_data_control <- df_filtered %>%
...
treated_summary <- df_filtered %>%
  group_by(Treated.Side.Score) %>%
  summarise(Frequency = n()) %>%
  mutate(Side = "Treated")

control_summary <- df_filtered %>%
...
write.xlsx(
  ...
  file = "C:/Users/rafre/Dropbox/Fiverr/Trabalhos/2024/dalia/analysis_results_Nopatient7.xlsx"
)
