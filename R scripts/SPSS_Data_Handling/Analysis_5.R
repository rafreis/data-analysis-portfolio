...
# Define the y-axes
y_axes <- c("Country_Avg_AVGESCS", "Country_Job_Satisfaction", "Desk_Percentage", 
...
vars_model1 <- c("InyourhomeAdesktostudyat"       ,           "InyourhomeAroomofyourown"     ,            
                "InyourhomeAquietplacetostudy"    ,          "InyourhomeAcomputeryoucanuseforschoolwork", "InyourhomeAlinktotheInternet"    ,         
...
full_model_formula_math3 <- paste("PisaMath ~", paste(vars_model2, collapse = " + "), "+ (1|NAME_CNT) + (1|ID_SCHOOL)")
