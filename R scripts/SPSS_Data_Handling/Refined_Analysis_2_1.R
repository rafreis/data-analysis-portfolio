...
clustering_results <- perform_hierarchical_clustering(df, vars_clustering)
...
k_range <- 3:8
df_with_clusters_list <- run_hierarchical_kmeans(df, vars_clustering, k_range)
...
clusterassignmentcolumn <- "Cluster_3"
...
df_segmented_freq <- create_segmented_frequency_tables(df_withclusters, categories_clustervars, "Cluster_3")
...
dot_whiskers_plot <- create_dot_and_whiskers_plot(df_withclusters, "Cluster_3", vars_to_plot1)
dot_whiskers_plot2 <- create_dot_and_whiskers_plot(df_withclusters, "Cluster_3", vars_to_plot2)
dot_whiskers_plot3 <- create_dot_and_whiskers_plot(df_withclusters, "Cluster_3", vars_to_plot3)
dot_whiskers_plot4 <- create_dot_and_whiskers_plot(df_withclusters, "Cluster_3", vars_to_plot4)
...
results_anova_clusters <- perform_anova_and_posthoc(df_withclusters, vars_to_plot1, "Cluster_3")
...
column_variable <- "Cluster_3"  # Replace with your column variable name

df_chisq6 <- chi_square_analysis_multiple(df_withclusters, row_variables, column_variable)
column_variable3 <- "Cluster_3"
...
save_apa_formatted_excel(data_list, "APA_Formatted_Tables_3clusters_new.xlsx")
