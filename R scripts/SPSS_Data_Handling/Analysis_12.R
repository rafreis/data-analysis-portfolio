...
vars_clustering <- c(  "Q2H_35_54"          ,                  
                       "Q2H_55_69"           ,                  "Q2H_70"   ,                           
                       "Q4_Woman"             ,                                 
                       "Q1H_Sydney_metropolitan",                                           
                       "Q5_50_000_to_80_000"   ,             
                       "Q5_80_001_to_120_000"   ,             "Q5_120_001___170_000"     ,          
                       "Q5_More_than_170_000"     ,                
                       "Q6_Year_12_of_high_school"  ,           "Q6_Technical_college_or_trade_courses",
                       "Q6_University_qualification" ,                         
                       "Q7B_Yes"                      ,                               
                       "Q8B_Yes"                       ,        "Q9B_Once_per_year_or_more"    ,        
                                               
                       "Q11_Part_time_or_casual"        ,       "Q11_Self_employed"  ,                  
                       "Q11_Unemployed"                  ,      "Q11_Retired"       ,                   
                       "Q11_Other"                        ,     "Q11_Pensioner"      ,                  
                       "Q12AB_Australian_Labor_Party"      ,   
                       "Q12AB_The_Greens"                   ,   "Q12AB_An_independent_or_other_party"  ,
                       "Q12AB_Dont_know_undecided"           ,  "Q15A_Yes"   ,                          
                                      
                       "Q16_Yes"                              ,               
                       "Q17_Yes"                               ,"Q19_Yes"      ,                        
                                                
                       "Q20_Yes"                              ,
                       "Attitudes_to_Drugs_norm"              ,
                       "Drug_Support_norm"                     ,"Policy_Support_norm"                                              
  )


dclustering_results <- perform_hierarchical_clustering(df_normalized, vars_clustering)
...
k_range <- 3:8
df_with_clusters_list <- run_hierarchical_kmeans(df_normalized, vars_clustering, k_range)
...
factors2 <- c("Cluster_5")
df_descriptive_clustervars_bycluster <- calculate_means_and_sds_by_factors(df_withclusters, numbers_clustervars, factors2)
...
df_segmented_freq <- create_segmented_frequency_tables(df_withclusters, categories_clustervars, "Cluster_4")
...
dot_whiskers_plot3 <- create_dot_and_whiskers_plot(df_withclusters, "Cluster_4", vars_to_plot3)
dot_whiskers_plot4 <- create_dot_and_whiskers_plot(df_withclusters, "Cluster_4", vars_to_plot4)
...
results_anova_clusters <- perform_anova_and_posthoc(df_withclusters, vars_to_plot1, "Cluster_4")
...
data_list <- list(
  ...
  "ANOVA Results" = anova_results_4clusters
)
